...
export function StudioCanvas() {
  ...
  return (
    <section
      ...
      className="order-3 min-h-0 overflow-y-auto bg-muted/50 p-4 md:p-8 lg:order-2"
    >
      <div
        className={cn(
          "device-frame mx-auto overflow-hidden rounded-2xl border bg-background shadow-lg transition-[max-width] duration-300 motion-reduce:transition-none",
