    ...
    <section className="border-t">
      <div className="container py-20 md:py-28">
        <figure className="mx-auto max-w-3xl text-center">
          <Quote className="mx-auto mb-6 size-10 text-accent" aria-hidden />
          <blockquote className="text-balance text-2xl font-heading font-medium leading-relaxed md:text-3xl">
